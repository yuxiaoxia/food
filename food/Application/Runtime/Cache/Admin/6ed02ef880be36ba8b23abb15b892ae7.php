...
<head>
  ...
  <style>
    body {
      ...
      height: 100%;
      position: fixed;
      background: url("/food/Public/Admin/images/bg.jpg");
...
<body>
  <form class="sui-form form-horizontal sui-validate myform" id="login-form" action="/food/index.php/Admin/User/dologin" method="post">
    <div>
      <h2>欢迎登录后台管理系统</h2>
      ...
      <div class="control-group">
        <label for="password" class="control-label">
          <img src="/food/index.php/Admin/User/verify" id="verifyImg" onclick="fleshVerify()" />
        </label>
        <div class="controls">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a href="/food/index.php/Admin/User/register" class="sui-btn btn-default">注册</a>
        </div>
      </div>
  ...
  <script>
    function fleshVerify() {
      ...
      document.getElementById('verifyImg').src = "/food/index.php/Admin/User/verify/" + time;
    }
    var $form = $("#login-form");
    ...
    $(function() {
      $("#login-btn").click(function(e) {
        ...
        var url = '/food/index.php/Admin/User/dologin';
        if (ok) {
          $.ajax({
            url: url,
            type: "POST",
