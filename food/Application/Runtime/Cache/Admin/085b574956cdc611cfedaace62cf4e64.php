  ...
  <div class="dl-tab-content">
    ...
    <div class="dl-nav-con">
      <div class="tab-content tab-wraped" id="tab-con">
        <div class="tab-pane active" data-slide="tab1" data-href="/food/index.php/Admin/Index/Rinfo">
          <div id="rest-info">
  <table class="sui-table table-bordered">
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
      ...
      <tr>
        ...
        <div class="tab-pane" data-slide="tab2" data-href="/food/index.php/Admin/Index/rupdate">

        </div>
        <div class="tab-pane" data-slide="tab3" data-href="/food/index.php/Admin/Index/user">
